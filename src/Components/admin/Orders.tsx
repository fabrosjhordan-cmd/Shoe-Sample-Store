import { FaChevronLeft, FaChevronRight, FaSortNumericUpAlt } from "react-icons/fa"
                    ...
                    <tbody>
                        {salesPage.map((data, index)=>(
                            <tr key={index}>
                                ...
                                <td className="px-4 py-3 border-l border-foreground/40"><button className="px-1 py-2 rounded-xl"><RiExternalLinkLine /></button></td>
                            </tr>
                        ))
                    }
                    </tbody>
